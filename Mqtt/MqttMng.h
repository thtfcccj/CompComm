...
//定义接收稍后处理，全局里定义
//此功能用于解决小型MCU中防止堆栈层数过多引起的程序问题，如;PIC.XC8中PIC16系列
//#define SUPPORT_MQTT_MNG_RCV_LATER        
...
#define MQTT_MNG_WORK_PAUSE            0x08   //工作暂停标志
  ...
  #define MQTT_MNG_EN_RCV                0x04   //允许收标志
  #define MQTT_MNG_BUF_RCV               0x02   //接收缓冲标志
#endif
