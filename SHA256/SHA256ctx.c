...
* Labeled and modified by: 1.AnSheng(https://github.com/monkeyDemon) 1st
*                          2.thtfcccj(https://github.com/thtfcccj)   2nd
* Copyright:
...
{
  sha256_init(&_Ctx);
  sha256_update(&_Ctx, pData, Len);
  sha256_final(&_Ctx, pResume);
}
